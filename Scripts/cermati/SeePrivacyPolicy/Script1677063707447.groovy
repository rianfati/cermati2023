...
WebUI.click(findTestObject('Object Repository/cermati/regTncPrivacyPolicyLink'))
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/privacyPolicyTitle'), 5)
