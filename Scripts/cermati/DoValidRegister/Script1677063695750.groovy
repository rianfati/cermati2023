...
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/regTncLink'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/regTncPrivacyPolicyLink'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/loginButton'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/registerButton'), 0)
WebUI.click(findTestObject('Object Repository/cermati/registerButton'))
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/VerificationMethodText'), 5)
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/verifySMSButton'), 5)
WebUI.verifyElementPresent(findTestObject('Object Repository/cermati/verifyWAButton'), 5)
